 ...
 */
public class HgmdImporter2009Test extends TestCase {
    
    public HgmdImporter2009Test(String testName) {
        super(testName);
    }
    ...
    public void test() throws Exception {
        ...
        HgmdImporter2009 importer = new HgmdImporter2009();
        
        File inFile = new File("src/test/resources/HGMD_2009_snip.txt");
